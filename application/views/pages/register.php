...
<form action="<?php echo base_url('registers/add_reg'); ?>" method="post"> 
                                <div class="wizard-navigation">
                                    <ul>
                                        <li><a href="#details" data-toggle="tab">Gender</a></li>
                                        <li><a href="#captain" data-toggle="tab">Detials</a></li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="details">
                                        <h4 class="info-text">Please choose gender first? </h4>
                                        <div class="row">
                                            <div class="col-sm-10 col-sm-offset-1">
                                                <div class="col-sm-6">
                                                    <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Male.">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Female">
